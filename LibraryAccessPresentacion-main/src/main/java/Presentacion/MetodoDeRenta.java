 ...
 * @author rober
 */
public class MetodoDeRenta extends javax.swing.JFrame {

    /**
     * Creates new form MetodoDeRenta
     */
    public MetodoDeRenta() {
        initComponents();
    }
    ...
    private void bnOxxoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnOxxoActionPerformed
        RentaPorOxxo oxxo = new RentaPorOxxo();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MetodoDeRenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MetodoDeRenta().setVisible(true);
            }
        });
    }
